...
class RemoteAuth extends BaseAuthStrategy {
    constructor({ clientId, dataPath, rmMaxRetries, store, backupSyncIntervalMs } = {}) {
    ...
    async storeRemoteSession(options) {
        ...
        if (pathExists) {
            ...
            await this.store.save({session: this.sessionName, path: path.join(this.dataPath, `${this.sessionName}.zip`)});
